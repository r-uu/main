...
public interface TaskWithDirectNeighboursService extends FXCService
{
	...
	{
		public TaskViewWithDirectNeighboursServiceReadyEvent(final TaskWithDirectNeighboursService service,
				final TaskWithDirectNeighbours view) {
			super(service, view);
		}
		...
		{
			TaskViewWithDirectNeighboursServiceReadyEvent.class.getModule()
