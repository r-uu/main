...
public interface TaskHierarchyService extends FXCService
{
	...
	{
		public TaskHierarchyComponentReadyEvent(final @NonNull TaskHierarchyAbstract taskHierarchy,
				final @NonNull TaskHierarchyService taskHierarchyService) {
			super(taskHierarchy, taskHierarchyService);
		}

		public TaskHierarchyAbstract component()
		{
			return source();
		}
		...
		{
			AddService.AddComponentReadyEvent.class.getModule()
