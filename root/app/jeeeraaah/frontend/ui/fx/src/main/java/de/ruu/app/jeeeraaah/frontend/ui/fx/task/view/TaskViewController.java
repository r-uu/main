...
//		eventDispatcherSelectedTaskChanged.add(e -> onSelectedTaskChanged(e));
	...
	@Override public void unpopulateView()
	{
		task = null;
		tfId         .textProperty    ().set("");
		tfName       .textProperty    ().set("");
		taDescription.textProperty    ().set("");
		dtPckrStart  .valueProperty   ().set(null);
		dtPckrEnd    .valueProperty   ().set(null);
		chkBxClosed  .selectedProperty().set(false);
	}
