...
{
	enum NeighbourType {
		SUPER, PREDECESSOR, SUB, SUCCESSOR,
	}

	void populateViewFor(@NonNull TaskBean task, @NonNull NeighbourType neighbourType);

	@NonNull
	ListView<TaskBean> listView();

	@NonNull
	List<TaskBean> selectedItems();
			...
			extends AbstractEvent<TaskListDirectNeighboursService, Object>
	{
		...
		@ApplicationScoped
		public static class TaskViewListDirectNeighboursServiceReadyEventDispatcher
		...
		{
			TaskViewListDirectNeighboursServiceReadyEvent.class.getModule()
