...
public class ReportService {
    ...
    private static void generateReport(Context ctx) {
        try {
            ...
            // Wenn data-Objekt vorhanden ist, konvertiere zu Map
            if (body.data != null) {
                @SuppressWarnings("unchecked")
                Map<String, Object> dataMap = (Map<String, Object>) body.data;
                parameters.putAll(dataMap);
            } else if (body.parameters != null) {
                parameters.putAll(body.parameters);
            }
    ...
    static class ReportRequest {
        ...
        public Object data; // Komplettes Datenobjekt (z.B. InvoiceData)
    }
}
